...
pub const KECCAK_SUCCESS: c_int = 0;
pub const KECCAK_INVALID_INPUT: c_int = 1;
pub const KECCAK_INVALID_OUTPUT_SIZE: c_int = 2;
pub const KeccakResult = c_uint;
pub extern fn keccak256(input: [*c]const u8, input_len: c_ulong, output: [*c]u8, output_len: c_ulong) KeccakResult;
pub extern fn keccak256_batch(inputs: [*c][*c]const u8, input_lens: [*c]const c_ulong, outputs: [*c][*c]u8, count: c_ulong) KeccakResult;
pub extern fn keccak256_output_size() c_ulong;
